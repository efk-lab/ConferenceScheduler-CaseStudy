...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler(ConferenceSchedulerException.class)
	protected ResponseEntity<Object> handleConferenceSchedulerException(ConferenceSchedulerException ex, WebRequest request) {
